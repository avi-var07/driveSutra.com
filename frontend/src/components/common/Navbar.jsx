    ...
    <header className="sticky top-0 z-50 backdrop-blur-sm bg-white/3 border-b border-white/6">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link to="/login" className="px-4 py-2 rounded-lg border border-white/10 bg-white/3 text-sm hover:scale-105 transition">Log In</Link>
      ...
      {open && (
        <div className="md:hidden px-6 pb-6">
          <div className="flex flex-col gap-3 rounded-xl p-4 backdrop-blur-md bg-white/4 border border-white/6">
            <Link to="/dashboard" className="py-2 px-3 rounded hover:bg-white/6">Dashboard</Link>
            ...
            <div className="mt-2 flex gap-2">
              <Link to="/login" className="flex-1 text-center px-3 py-2 rounded-lg border border-white/10 bg-white/3">Log In</Link>
